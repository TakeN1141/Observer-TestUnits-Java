...
public abstract class Person implements Active, Adaptable, Comparable<Person> {
	...
	public Person(String datum, String datum1, String datum2) {
    ...
    public abstract Object getFirstName();

	public abstract Object getNameCounter();

	public abstract <T> Comparable getLastName();

	public abstract void setFirstName(String input);

	public abstract void setNameCounter(int counter);
}